import { GITHUB_USERNAME, SITE_EMAIL, SITE_NAME } from "@/lib/seo";
            ...
            <div className="mt-6 border border-neutral-400/20 border-dashed p-4 md:p-5">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div className="flex flex-col gap-1">
                        <p className="text-sm text-neutral-200 tracking-tight">{SITE_NAME}</p>
                        <p className="text-xs font-mono text-neutral-500 uppercase tracking-wider">
                            Apps, FiveM &amp; RedM scripts from Toronto.
                        </p>
                    </div>
